 ...
 */
class getVisitesRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\VisitesRepository' shared autowired service.
     *
     * @return \App\Repository\VisitesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'VisitesRepository.php';

        return $container->privates['App\\Repository\\VisitesRepository'] = new \App\Repository\VisitesRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
