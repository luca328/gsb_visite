 ...
 */
class getMotifRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MotifRepository' shared autowired service.
     *
     * @return \App\Repository\MotifRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MotifRepository.php';

        return $container->privates['App\\Repository\\MotifRepository'] = new \App\Repository\MotifRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
